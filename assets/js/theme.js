// LOCAL OVERRIDE of al_folio_core's theme.js — single change: first-visit default
// theme is "light" instead of "system" (see determineThemeSetting). Keep in sync on upgrades.
...
let determineThemeSetting = () => {
  ...
  if (themeSetting != "dark" && themeSetting != "light" && themeSetting != "system") {
    themeSetting = "light"; // site default: light (was "system")
  }
  return themeSetting;
};
